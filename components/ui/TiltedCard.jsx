    ...
    >
      ...
      >
        <motion.img
          src={imageSrc}
          alt={altText}
          className="absolute top-0 left-0 rounded-2xl border border-white/8 object-cover shadow-2xl shadow-black/50 will-change-transform [transform:translateZ(0)]"
          style={{
            width: imageWidth,
            height: imageHeight
          }}
